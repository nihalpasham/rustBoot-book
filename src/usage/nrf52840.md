...
> Note:
> - If you're using a different version of the board, you'll probably need to edit firmware partitions adddresses to accomodate for differences. 
> - Just make sure you dont change the name of files/folders or the folder structure, as cargo xtask looks for these file/folder names.
...
Now that we have partitioned the `nrf52840`'s flash-storage, the next step is - `compiling, signing and programming ` 

We will compile the following and sign both pieces of firmware with a (test) [private-key](https://github.com/nihalpasham/rustBoot/tree/main/boards/rbSigner/keygen).
- bootloader 
- boot and update firmware

and finally create valid [`rustBoot mcu-images`](../arch/images.md#mcu-image-format) i.e. signed boot and update firmware.
